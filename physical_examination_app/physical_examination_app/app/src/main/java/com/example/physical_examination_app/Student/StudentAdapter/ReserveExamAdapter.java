...
public class ReserveExamAdapter extends BaseAdapter {
    ...
    public ReserveExamAdapter(Context context, List<Map<String,String>> dataSource,int item_layout){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        examTeacher.setText("负责老师："+item.get("teacher"));
    ...
    private void getViews(View view) {
        ...
        examTeacher = view.findViewById(R.id.exam_status);
